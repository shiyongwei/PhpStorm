...
<div class="container">
    ...
    需要<strong>帮助？ </strong>
		...
		<div class="main_cont span9">
			<h1><?php echo $cityinfo['cit_name']?> 摩托车租赁</h1>

			<div class="search_bar">

				<h4>
					<span class="no_results"><?php echo count($rentinfo)?></span>
					现有摩托车车型
				</h4>
				...
				<div class="row js-vehiclesContainer" data-equalizer="pp556y-equalizer" data-equalize-by-row="true" data-locationid="" data-resize="ybtvek-eq" data-events="resize" style="margin-left: -15px;">
					...
					<?php foreach ($rentinfo as $key=> $rentinfos): ?>
						...
						<div class="rideList promotionBox js-motorcycle boxs">
							...
							<a class="specification btn-highlight small js-specsTrigger specis" href="Javascript:;" title="<?php echo $rentinfos['productitle']?>" onclick="product_list_show('<?php echo $rentinfos['productitle']?>','/index.php/admin/admin/product_list_details?id=<?php echo $rentinfos['id'];?>','800','650')">
							...
							<a href="Javascript:;" style="text-decoration: none !important;display: block;">
								<h3 class="ride_title bold js-name ridetitles"><?php echo $rentinfos['productitle']?></h3>
							</a>



							<span class="bike-class" style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;margin-left: 7px;">
								<span class="rate" id="detail_14" style="color: gray">每天:<em class="bold" dir="ltr" id="detail_15" style="color: #d41f1f"> <?php echo $rentinfos['day_price']?></span>
							</span></br>
							<span class="bike-class" style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;margin-left: 7px;">
								<span class="rate" id="detail_14" style="color: gray">每周:<em class="bold" dir="ltr" id="detail_15" style="color: #d41f1f"> <?php echo $rentinfos['week_price']?></span>
							</span>
                        </span>
