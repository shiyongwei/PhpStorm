...
<script>
	...
	$('.en').click(function() {
		window.location.href='/index.php/news_detail?id='+id+'&&lang=en';
	});
	$('.cn').click(function() {
		window.location.href='/index.php/news_detail?id='+id;
	});
</script>
	...
	<div class="row">
		...
		<?php if(isset($_GET["lang"])): ?>
			<div class="main_cont span9" style="margin-top: 35px">
				<style>
					.news{
						width: 100%;height: 50px;background: #dcdada;margin-top: 5px;line-height: 50px;padding-left: 15px;
					}
					.content{
						margin-top:10px;width: 100%;min-height: 30px;background: #dcdada;line-height: 30px;padding-left: 15px;
					}
				</style>

					<a>
						<div class="news"><?php echo $news_detail['title_en'] ?></div>
					</a>
					<div class="content"><?php echo $news_detail['text_en'] ?></div>
		...
		<?php if(empty($_GET["lang"])): ?>
			<div class="main_cont span9" style="margin-top: 35px">
				<style>
					...
					<a>
						<div class="news"><?php echo $news_detail['title'] ?></div>
					</a>
					<div class="content"><?php echo $news_detail['text'] ?></div>
