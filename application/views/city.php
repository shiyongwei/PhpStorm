                        ...
                        <form action="/reservation_widget" method="post" class="res_widget" target="_blank">
                            ...
                            <div class="form_bot">
                                ...
                                <div class="field-block">
                                    ...
                                    <div class="dateTime">
                                        <div class="DepDate">
                                            <input type="text" name="reservation[pickup_date]" readonly="true" class="js-pickupDate" value="05/24/2018">
                                ...
                                <div class="field-block returning-date">
                                    ...
                                    <div class="dateTime">
                                        <div class="DepDate">
                                            <input type="text" name="reservation[dropoff_date]" readonly="true" class="js-dropoffDate" value="05/25/2018">
