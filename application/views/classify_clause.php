<script>
	$('.en').click(function() {
		...
		window.location.href='/index.php/classify_clause?lang=en';
	});
	$('.cn').click(function() {
		window.location.href='/index.php/classify_clause';
	});
</script>
    ...
    <div class="row">
		...
		<?php if(isset($_GET["lang"])): ?>
            <div class="main_cont span9" style="margin-top: 35px">
				<?php echo $bottom_info[1]['text_en']?>
            </div>
		<?php endif; ?>
		<?php if(empty($_GET["lang"])): ?>
            <div class="main_cont span9" style="margin-top: 35px">
				<?php echo $bottom_info[1]['text']?>
            </div>
		<?php endif; ?>
