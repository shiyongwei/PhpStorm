...
<link href="/public/css/faq.css" type="text/css" rel="stylesheet" />
<div class="js-page">
	<div class="container">
		<div class="row">
			<!-- left side -->
					...
					<div class="js-rentalSearch" style="">
						...
						<div class="js-reservationFormContainer">
							<form action="/reservation_widget" method="post" class="res_widget" target="_blank">
								<input type="hidden" name="authenticity_token" value="UYegiHmy7j521q1+co8RUasaGwMG+vfJhRGd9vqErfc=">
          ...
          取车城市
            ...
            与取车城市相同
									...
									<div class="field-block">
										...
										<div class="dateTime">
											<div class="DepDate">
												<input type="text" name="reservation[pickup_date]" readonly="true" class="js-pickupDate hasDatepicker" value="06/17/2018" id="dp1529241216000">
									...
									<div class="field-block returning-date">
										...
										<div class="dateTime">
											<div class="DepDate">
												<input type="text" name="reservation[dropoff_date]" readonly="true" class="js-dropoffDate hasDatepicker" value="06/18/2018" id="dp1529241216001">
					...
					<div class="js-toursSearch" style="display:none;">
						...
						<div class="js-toursFormContainer">
							<form accept-charset="UTF-8" action="/tours/search_widget" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="✓"><input name="authenticity_token" type="hidden" value="UYegiHmy7j521q1+co8RUasaGwMG+vfJhRGd9vqErfc="></div>
          ...
          取车城市
            ...
            与取车城市相同
									...
									<div class="field-block">
										...
										<div class="dateTime">
											<div class="DepDate">
												<input type="text" name="reservation[pickup_date]" readonly="true" class="js-pickupDate hasDatepicker" value="06/18/2018" id="dp1529241216002">
												<span class="icn-Calendar js-pickupDateTrigger"></span>
											</div>
									...
									<div class="field-block returning-date">
										...
										<div class="dateTime">
											<div class="DepDate">
												<input type="text" name="reservation[dropoff_date]" readonly="true" class="js-dropoffDate hasDatepicker" value="06/19/2018" id="dp1529241216003">
												<span class="icn-Calendar js-dropoffDateTrigger"></span>
											</div>
    ...
    需要<strong>帮助？ </strong>
			...
			<div class="main_cont span9">
				...
				<div class="search_bar">
					<form class="search" action="/faqs" method="get">
						<input type="text" class="input-medium" placeholder="搜索常见问题" name="q" value="">
				...
				<div class="accordion" id="faqItem">
					<div class="accordion-group">
						<div class="accordion-heading">
							<a class="accordion-toggle" data-toggle="collapse" href="#collapse-1-0">
								<h3>需要什么样的驾照才能在鹰骑租车？</h3>
								<span class="toggle_icon"> 收回/打开 </span>
							</a>
							<div class="clearfix"></div>
						</div>

						<div id="collapse-1-0" class="accordion-body collapse in">
