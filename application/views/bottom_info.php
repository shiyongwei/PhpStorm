<script>
    $(function(){
        ...
        if (MobileUA.SMART_PHONE) {
            ...
            document.location.href = '/index.php/Bottom_info/mobile_Bottom_info';
        }
    });
	$('.en').click(function() {
		var url = window.location.href;
		window.location.href='/index.php/Bottom_info?lang=en';
	});
	$('.cn').click(function() {
		window.location.href='/index.php/Bottom_info';
	});
</script>
				...
				<div class="row-fluid" style="width: 100%;">
					...
					<div class="span3" style="margin-left: 0;">
						<div class="link-container" style="height: 130px;margin: 0 auto;border: none;display: table;padding: 5px;font-weight: bold;color: #555;">
							...
							<a href="<?php echo $bottom_infos['url']?>?lang=en" style="border-radius: 100px;display: table-cell;vertical-align: middle;text-align: center;font-size: 15px;line-height: 18px;color: #555;text-decoration: none !important;opacity: 0.85;">
								<img src="<?php echo $bottom_infos['image']?>">
								<i class="icn-stuff icn-license" style="margin: 0 auto 10px;text-align: center;line-height: 37px;display: block;"></i><?php echo $bottom_infos['title_en']?>
							</a>
						</div>
					</div>
					<?php endif; ?>
