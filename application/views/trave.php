                        ...
                        <div class="options js-options">
                            <ul class="optionsblk widgetTabs">
                                <li class=" js-rentalTrigger">
                                    <a href="/index.php/Home">rent</a>
                                </li>

                                <li class="packages ">
                                    <a href="/index.php/Hotels">motorcycle &amp; hotels</a>
                                </li>

                                <li class="selected js-toursTrigger">
                                    <a href="Javascript:;">trave</a>
                                </li>
                                                ...
                                                <div class="span12">
                                                    ...
                                                    <div class="select2-container selectWithSearch js-searchableSelect" id="s2id_tour_id">
                                                        <a href="javascript:void(0)" class="select2-choice" tabindex="-1">
                                                            <span class="select2-chosen" id="select2-chosen-11">All Tour package name</span><abbr class="select2-search-choice-close"></abbr>
