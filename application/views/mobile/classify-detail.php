                    ...
                    <div class="tour-view-wrapper">
                        <div class="row page-title">
                            <div class="small-12 columns">
								<?php if(isset($_GET["lang"])): ?>
                                    <h3><?php echo $uriving['urivingtitle_en']?></h3>
                                    <span class="class-mame">Self-driving Tours - <span class="day-night"><?php echo $uriving['day_en']?></span>
								<?php endif; ?>
								<?php if(empty($_GET["lang"])): ?>
                                    <h3><?php echo $uriving['urivingtitle']?></h3>
                                    <span class="class-mame">自驾游 旅游 - <span class="day-night"><?php echo $uriving['day']?></span>
									<?php endif; ?>
                                </span>
                        ...
                        <div class="page-wrapper">
                            <div class="er-page-header">
                                  <span class="js-map-container" data-segment-id="0">
                                    <img class="er-page-header_img" src="<?php echo $uriving['image']?>" style="height: 195px;">
                                  </span>
                        ...
                        <div class="row overview show-for-all" id="overview" data-magellan-target="overview">
                            ...
                            <div class="small-4 column icons" dir="ltr">
                                <svg></svg>
                                <span><?php echo $uriving['kilometers_en']?></span>

                            </div>

                            <div class="small-4 column icons">
                                <svg></svg>
                                <span><?php echo $uriving['season_en']?></span>
                            </div>

                            <div class="small-4 column icons">
                                <svg></svg>
                                <span><?php echo $uriving['temperature_en']?></span>
						...
						<?php if(empty($_GET["lang"])): ?>
                            <div class="row overview show-for-all" id="overview" data-magellan-target="overview">
                                ...
                                <div class="small-4 column icons" dir="ltr">
                                    <svg></svg>
                                    <span><?php echo $uriving['kilometers']?></span>

                                </div>

                                <div class="small-4 column icons">
                                    <svg></svg>
                                    <span><?php echo $uriving['season']?></span>
                                </div>

                                <div class="small-4 column icons">
                                    <svg></svg>
                                    <span><?php echo $uriving['temperature']?></span>
...
<script>
	...
	$('.en').click(function() {
		window.location.href='/index.php/detail/mobile_Detail?id='+id+'&&lang=en';
	});

	$('.cn').click(function() {
		window.location.href='/index.php/detail/mobile_Detail?id='+id;
	});
</script>