									...
									<div class="card  tours-card">
										...
										<div class="card-content">
											<ul class="menu align-left">
												<li> <br> <span><?php echo $teams['day_en']?></span></li>
												<li>
													<?php echo $teams['price']?><br> <span>The starting price</span>
												</li>
											</ul>
											<a class="button expanded" href="/index.php/Team_detail/mobile_Team_detail?id=<?php echo $teams['id']?>">View tour routes</a>
										</div>
									</div>
								</div>
								<?php endforeach; ?>
...
<script>
	...
	$('.en').click(function() {
		window.location.href='/index.php/team/mobile_Team?lang=en';
	});

	$('.cn').click(function() {
		window.location.href='/index.php/team/mobile_Team';
	});
</script>