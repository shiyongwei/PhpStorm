...
<div class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-article-add" onsubmit="return false">
        ...
        <?php if (isset($announcement['lang'])): ?>
            <input type="hidden" name="lang" value="<?php echo $announcement['lang'];?>">
        <?php endif; ?>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>公告：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $announcement['text'];?>" placeholder="" id="" name="text">
			</div>
		</div>
		<div class="row cl">
...
function article_save_submit()
{
    ...
    $.post('/index.php/admin/Announcement/announcement_edit',{'str':str},function(data) {
