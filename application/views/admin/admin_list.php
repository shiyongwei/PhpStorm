...
<!--                    <a style="text-decoration:none" onClick="admin_stop(this,'10001')" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a>-->
                    <a title="编辑" href="javascript:;" onclick="admin_edit('管理员编辑','admin_add?id=<?php echo $value['id']; ?>','1','500','305')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                    <a title="删除" href="javascript:;" onclick="admin_del(this,'<?php echo $value['id']; ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
                </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
    ...
    */
    ...
    function admin_del (obj, id) {
        layer.confirm('确认要删除吗？', function(index) {
            $.post('/index.php/admin/LoginController/login_del', {'id': id}, function(data) {
                if(data == 200)
                {
                    ...
                    layer.msg('超级管理员不能删除', {icon: 6, time: 1000});
                }
                else
                {
