    ...
    <form action="" method="post" class="form form-horizontal" id="form-article-add" onsubmit="return false">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $cite_edit['cit_name'];?>" placeholder="" id="" name="cit_name">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">地址:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="address" id="" placeholder="" value="<?php echo $cite_edit['address'];?>" class="input-text">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">联系方式:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="information" id="" placeholder="" value="<?php echo $cite_edit['information'];?>" class="input-text">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">营业时间：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="time" id="" placeholder="" value="<?php echo $cite_edit['time'];?>" class="input-text">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <select class="select" name="status" size="1">
                    <option value="0" <?php echo $cite_edit['status'] == 0 ? 'selected' : '';?>>普通</option>
                    <option value="1" <?php echo $cite_edit['status'] == 1 ? 'selected' : '';?>>广告</option>
                </select>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">logo缩略图：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <div class="uploader-thum-container">
                    <img src="<?php echo $cite_edit['logo'];?>" alt="" style="width: 200px;height: 200px;">
                </div>
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="text" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"><?php echo $cite_edit['text'];?></textarea>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <script id="editor" type="text/plain" style="width:100%;height:400px;"><?php echo $cite_edit['valder'];?></script>
                </div>
                </div>
                <div class="row cl">
                ...
                <script type="text/javascript">
                    ...
                    function article_save_submit () {
                        ...
                        $.post('/index.php/admin/CityController/city_edit',{'str':str},function(data) {
                            ...
                            if(data == 200){
                                ...
                                layer.msg('不能将分类放置到当前分类或其子分类',{icon:4,time:2000});
