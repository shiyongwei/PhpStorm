	...
	<form action="" method="post" class="form form-horizontal" id="form-article-add" onsubmit="return false">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>所属团队游：</label>
				...
				<?php foreach ($team as $key): ?>
                    <option value="<?php echo $key['id'];?>"<?php echo $key['id'] == $photo['team_id'] ? 'selected' : '';?>><?php echo $key['teamtitle']; ?></option>
                <?php endforeach; ?>
                  </select>
				</span>
            </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <script id="editor" type="text/plain" style="width:100%;height:400px;"><?php echo $photo['image'];?></script>
                </div>
         </div>
		<div class="row cl">
...
function article_save_submit()
{
    ...
    $.post('/index.php/admin/Photo/photo_edit',{'str':str},function(data) {
