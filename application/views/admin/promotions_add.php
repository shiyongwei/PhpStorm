	...
	<form action="" method="post" class="form form-horizontal" id="form-article-add" onsubmit="return false">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="promtitle">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="worth" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">折扣：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="discount" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">你省去了：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="save" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">在此之前预订：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="booking" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">在此期间取车：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="during" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">取车于：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="thecar" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">还车于：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="cartime" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">最少车辆数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="vehicles" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">最少租赁天数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="day" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">购买条款：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="terms" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">联系方式：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="city" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
...
function article_save_submit()
{
    ...
    $.post('/index.php/admin/Promotions/promotions_add',{'str':str},function(data) {
