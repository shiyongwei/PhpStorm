	...
	<form action="" method="post" class="form form-horizontal" id="form-article-add" onsubmit="return false">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="productitle">
			</div>
		</div>
        <div class="row cl">
            ...
            <?php if (empty($brand)): ?>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="请先添加品牌" readonly>
                </div>
            <?php else: ?>
        ...
        <div class="row cl">
            ...
            <?php if (empty($category)): ?>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="请先添加类型" readonly>
                </div>
            <?php else: ?>
                <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="displacement" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">后轮胎：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="reartyre" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">前轮胎：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="fronttire" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">后制动器：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="rearbrake" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">前刹车：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="frontbrake" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">座位高度：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="seatheight" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">压缩比：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="compression" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">油箱容量：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="capacity" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">挡风玻璃：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="windshield" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
...
function article_save_submit()
{
    ...
    $.post('/index.php/admin/ListController/list_add',{'str':str},function(data) {
