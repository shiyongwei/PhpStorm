    ...
    <form action="" method="post" class="form form-horizontal" id="form-article-add" onsubmit="return false">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="title" id="" placeholder="" value="<?php echo $text['title'];?>" class="input-text">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <div class="uploader-thum-container">
                    <img src="<?php echo $text['image'];?>" alt="" style="width: 200px;height: 200px;">
                </div>
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <script id="editor" type="text/plain" style="width:100%;height:400px;"><?php echo $text['text'];?></script>
                </div>
                </div>
                <div class="row cl">
                ...
                <script type="text/javascript">
                    ...
                    function article_save_submit () {
                        ...
                        $.post('/index.php/admin/Text/text_edit', {'str': str}, function(data) {
