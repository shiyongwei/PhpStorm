...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-admin-role-add" onsubmit="return false">
        <input type="hidden" value="<?php echo $theme['id']; ?>" name="id">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $theme['name']; ?>" placeholder="" id="roleName" name="name">
			</div>
		</div>
		<div class="row cl">
...
<script type="text/javascript">
     ...
     $('#admin-role-save').click(function() {
         ...
         $.post('/index.php/admin/Theme/theme_edit',{'str':str},function(data) {
