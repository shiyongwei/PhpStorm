    ...
    <form action="" method="post" class="form form-horizontal" id="form-article-add" onsubmit="return false">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="" name="cit_name">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="information" id="" placeholder="" value="" class="input-text">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">营业时间：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="time" id="" placeholder="" value="" class="input-text">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <script type="text/javascript">
                    ...
                    function article_save_submit () {
                        ...
                        $.post('/index.php/admin/CityController/city_add', {'str': str}, function(data) {
