...
<div class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-article-add" onsubmit="return false">
        ...
        <?php if (isset($side['lang'])): ?>
            <input type="hidden" name="lang" value="<?php echo $side['lang'];?>">
        <?php endif; ?>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $side['title'];?>" placeholder="" id="" name="title">
			</div>
		</div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">描述头部：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" name="head" id="" placeholder="" value="<?php echo $side['head'];?>" class="input-text">
                </div>
            </div>
            <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <div class="uploader-thum-container">
                    <img src="<?php echo $side['image'];?>" alt="" style="width: 200px;height: 200px;">
                </div>
            </div>
        </div>
		<div class="row cl">
