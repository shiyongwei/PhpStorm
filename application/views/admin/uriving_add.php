	...
	<form action="" method="post" class="form form-horizontal" id="form-article-add" onsubmit="return false">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="urivingtitle">
			</div>
		</div>
        <div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="kilometers" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">季节：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="season" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">温度：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="temperature" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
        <div class="row cl">
...
function article_save_submit()
{
    ...
    $.post('/index.php/admin/Uriving/uriving_add',{'str':str},function(data) {
