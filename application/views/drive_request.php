...
<div class="container">
    ...
    需要<strong>帮助？ </strong>
        ...
        <div class="main_cont span9" style="margin-top: 35px">
            ...
            <h1 class="bold">摩托车租赁对驾照的要求</h1>

            <div class="TCcontent">
                <p>如果您持有本国的有效驾照，即可在鹰骑租赁到驾照上允许您行驶的同等类型的摩托车。需要注意的是，您在整个租赁过程中必须遵守您取车门店所在州的法律</p>
                <h3>从美国的门店取车:</h3>
                <h4 class="bold">美国签发的驾照:</h4>
                <ul><li>两轮摩托车<ul><li>所有50个州都要求有效驾照并附上公证，驾照上会写明您可以租赁的摩托车类型。</li></ul></li><li>三轮车摩托车<ul><li>可能会要求您出具一份三轮摩托车驾照公证</li></ul></li></ul>
                <br>

                <h3>这里例举了一些我们接受的其他地区签发的驾照:</h3>
                <br>
                <div class="note-container" style="border: 2px solid #333;margin-bottom: 20px;padding: 10px 20px;">
                    <div class="row-fluid" style="    width: 100%;">
                        <div class="span1"><span class="icons-baseline-warning" style="background-image: url('/public/image/icons-sc2669c717a-76a13256c983403eab4ece1b41db760a.png');background-repeat: no-repeat;"></span></div>
                        <div class="span11">
                            <p style="color: #ed7b19;font-size: 16px;font-weight: bold;text-transform: uppercase;">Must be 21 years old with a valid license from state, province or country that allows renter to operate a 125cc Motorcycle.</p>
                        </div>
                    </div>
                </div>
                <p class="bold">由欧盟签发的驾照（德国，意大利，法国，英国，奥地利，比利时，保加利亚，克罗地亚，塞浦路斯共和国，捷克共和国，丹麦，爱沙尼亚，芬兰，希腊，匈牙利，爱尔兰，拉脱维亚，立陶宛，卢森堡，马耳他，荷兰，波兰，葡萄牙，罗马尼亚，斯洛伐克，斯洛文尼亚，西班牙和瑞典）:</p>
                <ul><li>A1/A2-允许您租赁踏板摩托车。</li><li>A-允许您租赁摩托车或者踏板车。</li><li>B1-允许您租赁三轮摩托车。</li></ul>
                <br>

                <p class="bold">加拿大签发的驾照:</p>
                <ul><li>Class 6 designation – 适用于除了安大略省以外的所有地区<ul><li>安大略<ul><li>Class M1/M2：允许您租赁踏板摩托车</li><li>Class M：允许您租赁摩托车或者踏板摩托车</li><li>Class M Condition M：允许您租赁三轮摩托车</li></ul></li></ul></li></ul>
                <br>

                <p class="bold">澳大利亚签发的驾照:</p>
                <ul><li>R-Date——允许您行驶踏板摩托车。</li><li>R——允许您行驶摩托车或踏板摩托车。</li></ul>
                <br>

                <p class="bold">巴西签发的驾照:</p>
                <ul><li>Category A——根据摩托车驾照上的指示可以行驶任何摩托车或踏板摩托车</li></ul>
                <br>

                <p class="bold">国际驾照（不是鹰骑必需的）: </p>
                <ul><li>虽然不是必需的，但我们仍建议非英语国家的游客持有国际驾照。</li><li>当然如果您的驾照我们可以读懂，也是可以的。</li></ul>
                <br>
            </div>
        </div>
