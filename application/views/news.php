<script>
	$('.en').click(function() {
		...
		window.location.href='/index.php/news?lang=en';
	});
	$('.cn').click(function() {
	...
	<div class="row">
		...
		<?php if(isset($_GET["lang"])): ?>
			<div class="main_cont span9" style="margin-top: 35px">
				...
				<?php foreach ($news as $key=>$new): ?>
                    <a href="/index.php/news_detail?id=<?php echo $new['id'] ?>&&lang=en">
                        <div class="news"><?php echo $new['title_en'] ?></div>
                    </a>
				<?php endforeach; ?>
			</div>
		<?php endif; ?>
		<?php if(empty($_GET["lang"])): ?>
			<div class="main_cont span9" style="margin-top: 35px">
				...
				<?php foreach ($news as $key=>$new): ?>
                    <a href="/index.php/news_detail?id=<?php echo $new['id'] ?>">
                        <div class="news"><?php echo $new['title'] ?></div>
                    </a>
				<?php endforeach; ?>
